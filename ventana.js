...
export function dibujarObjeto(objeto, color = 'red'){
    pincel.beginPath();
    pincel.arc(objeto.x - camara.x, objeto.y - camara.y, objeto.radio, 0, Math.PI * 2);
...
export function dibujarRectangulo(objeto, color = 'blue') {
    pincel.beginPath();
    pincel.fillStyle = color;
    pincel.fillRect(objeto.x - camara.x, objeto.y - camara.y, objeto.ancho, objeto.alto);
    pincel.closePath();
}

export function dibujarCirculo(x, y, r = radio, color = 'black'){
    pincel.beginPath();
    pincel.arc(x - camara.x, y - camara.y, r, 0, Math.PI * 2);
    pincel.fillStyle = color;
    pincel.fill();
    pincel.closePath();
}
